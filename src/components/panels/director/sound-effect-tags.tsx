...
/**
 * Sound Effect标签Select器组件 (Sound Effect Tags)
 * 用于SelectShot的Sound Effect标签：自然环境、人物动作、氛围效果等
 */
        ...
        {value.length < maxTags && !disabled && (
          <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            <PopoverContent className="w-64 p-2" align="start">
              <p className="text-sm font-medium mb-2">Select Sound Effects ({value.length}/{maxTags})</p>
