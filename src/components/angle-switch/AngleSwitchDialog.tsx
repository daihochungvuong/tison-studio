      ...
      <DialogContent className="max-w-sm p-4 bg-zinc-900 border-zinc-800">
        <DialogHeader className="pb-2">
          <DialogTitle className="text-sm text-white">
            Switch Viewpoint - {frameType === "start" ? "First Frame" : "Last Frame"}
          </DialogTitle>
          <DialogDescription className="sr-only">
            Select target viewpoint via 3D spherical controller, drag to rotate, scroll to zoom
          </DialogDescription>
        </DialogHeader>
